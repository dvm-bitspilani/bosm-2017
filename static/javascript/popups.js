...
for (var i in cossac) {
	...
	cossacul.append('\
		<li>\
			<div class="proPic" style="background-image: url(assets/images/cossac/'+cossacn.img+')"></div>\
			<div class="info">\
...
for (var i in spons) {
	...
	sponsul.append('\
		<li>\
			<div class="proPic" style="background-image: url(assets/images/sponsors/'+sponsor.logo+')"></div>\
			<div class="info">\
